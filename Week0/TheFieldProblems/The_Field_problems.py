...
def mySum(L):
    ...
    Examples:
      ...
      18
    '''
    return list(reduce(lambda x, y: x + y, L, 0))
...
Be sure your procedure works for the empty list.
    Examples:
      ...
      -24
    '''
    return list(reduce(lambda x, y: x * y, L, 1))
...
def myMin(L):
    ...
    -5
    '''
    return list(reduce(lambda x, y: x if x < y else y, L, float('inf')))
...
Be sure your procedure works for the empty list.
    ...
    {3, 5}
    '''
    return set(reduce(lambda x, y: x | y, L, set([])))
